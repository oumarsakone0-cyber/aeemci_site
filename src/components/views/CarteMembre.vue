        ...
        <div class="form-content">
          <form @submit.prevent="initierPaiement">
              ...
              <div class="form-group">
                ...
                <div class="radio-group radio-group-horizontal">
                  <label class="radio-item radio-item-compact">
                    ...
                    <span class="radio-label">Membre Actuel</span>
                  </label>
                  <label class="radio-item radio-item-compact">
                    <input
                      v-model="formData.type_membre"
                    ...
                    />
                    <div class="radio-custom"></div>
                    <span class="radio-label">Ancien Membre</span>
                  </label>
                </div>
              </div>
              <div v-if="formData.type_membre === 'ANCIEN'" class="info-box">
                <div class="info-icon">
                ...
                <div class="info-content">
                  <h4>Ancien Membre</h4>
                  <p>Vos postes seront automatiquement préfixés par "Past" (ex: Past Secrétaire Général, Past Imam, etc.)</p>
                </div>
              </div>
            </div>
            ...
            <div v-if="currentStep === 2" class="step-content">
              ...
              <!-- Les champs de militantisme s'affichent pour tous les types de membres -->
              <div class="form-grid">
                <div class="form-group">
                  <label class="form-label">
                    <svg class="label-icon" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div v-if="currentStep === 3" class="step-content">
              <h2 class="step-heading">
                ...
                {{ formData.type_membre === 'ANCIEN' ? 'Dernier Statut et Poste' : 'Statut et Poste' }}
              </h2>
              <!-- Nouveau champ Organes -->
              <div class="form-group">
                <label class="form-label">Organes : <span class="required">*</span></label>
                <div class="radio-group radio-group-horizontal">
                  <!-- Comité Exécutif pour tous les membres -->
                  <label class="radio-item radio-item-compact">
                    <input
                      v-model="formData.organe"
                      type="radio"
                      value="COMITE_EXECUTIF"
                      class="radio-input"
                      @change="resetStatutFields"
                    />
                    <div class="radio-custom"></div>
                    <span class="radio-label">Organes centraux, CNP</span>
                  </label>
                  <label class="radio-item radio-item-compact">
                    <input
                      v-model="formData.organe"
              ...
              <div v-if="formData.organe" class="form-group">
                ...
                <div class="radio-group">
                  <!-- Options pour Comité Exécutif -->
                  <template v-if="formData.organe === 'COMITE_EXECUTIF'">
                    <label class="radio-item">
                      ...
                      />
                      <div class="radio-custom"></div>
                      <span class="radio-label">Membre du Comité Exécutif</span>
                    </label>
                    <label class="radio-item">
                      <input
                        v-model="formData.statut"
                      ...
                      />
                      <div class="radio-custom"></div>
                      <span class="radio-label">Membre du Commissariat Central aux Comptes</span>
                    </label>
                    <label class="radio-item">
                      <input
                        v-model="formData.statut"
                      ...
                      />
                      <div class="radio-custom"></div>
                      <span class="radio-label">Membre du Conseil d'Administration</span>
                    </label>
                    <label class="radio-item">
                      <input
                        v-model="formData.statut"
                      ...
                      />
                      <div class="radio-custom"></div>
                      <span class="radio-label">Membre du Conseil Consultatif</span>
                    </label>
                    <label class="radio-item">
                      <input
                        v-model="formData.statut"
                      ...
                      />
                      <div class="radio-custom"></div>
                      <span class="radio-label">Membre du Conseil National Pédagogique</span>
                    </label>
                  </template>
              ...
              <!-- Membre Comité Exécutif (MEMBRE_CE, MEMBRE_CA, MEMBRE_CC, MEMBRE_CNP) -->
              <div v-if="['MEMBRE_CE', 'MEMBRE_CA', 'MEMBRE_CC', 'MEMBRE_CNP', 'MEMBRE_CCC', 'MEMBRE_CP'].includes(formData.statut)" class="conditional-fields">
                <div class="form-group">
                    ...
                    >
                      ...
                      >
                        <div class="poste-item">
                          ...
                          <div v-if="getPosteDefinition(poste)" class="poste-definition">
                  ...
                  <div v-if="formData.poste" class="poste-selected-definition">
                    <small class="definition-text">
                      <strong>{{ getDisplayPoste() }}</strong>
                      <span v-if="getPosteDefinition(formData.poste)"> : {{ getPosteDefinition(formData.poste) }}</span>
                    </small>
                  </div>
                </div>
              </div>
                ...
                <div class="form-grid">
                  ...
                  <div class="form-group">
                    ...
                    <div v-if="formData.posteDefinition" class="poste-selected-definition">
                      <small class="definition-text">
                        <strong>{{ getDisplayPoste() }}:</strong> {{ formData.posteDefinition }}
                      </small>
                    </div>
                  </div>
                </div>
              ...
              <div v-if="formData.statut === 'SOUS_COMITE'" class="conditional-fields">
                <div class="form-grid">
                  ...
                  <div class="form-group">
                    <label class="form-label">{{ formData.type_membre === 'ANCIEN' ? 'Dernier Sous-comité' : 'Sous-comité actuel' }} (Saisir la Commune ou la Ville ) <span class="required">*</span></label>
                    <div class="input-container">
                      <input
              ...
              <div v-if="formData.statut === 'BUREAU_SECTION'" class="conditional-fields">
                <div class="form-grid">
                  ...
                  <div class="form-group">
                    <label class="form-label">{{ formData.type_membre === 'ANCIEN' ? 'Dernière Section' : 'Section' }} <span class="required">*</span></label>
                    <div class="input-container">
                      <input
              ...
              <div v-if="formData.statut === 'MEMBRE_SIMPLE'" class="conditional-fields">
                <div class="form-grid">
                  <div class="form-group">
                    <label class="form-label">Secrétariat Régional {{ formData.type_membre === 'ANCIEN' ? 'Actuel' : 'Actuel' }} <span class="required">*</span></label>
                    <div class="autocomplete-container">
                      <div class="input-container">
                        <input
                          v-model="secretariatPosteSearch"
...
// État du formulaire
const currentStep = ref(0) // Commencer à l'étape 0
const totalSteps = 5
...
// Étapes du formulaire (mise à jour avec la nouvelle étape)
const steps = [
  { title: 'Type de membre' }, // Nouvelle étape 0
...
// Base lists of postes
const basePostesCE = [
  'AMIR', 'Vice-Amir', 'Vice Amirate', 'SENAFI', 'SENAFOCI', 'SENAFOCUS', 'SENACEF',
  'SENAFAD', 'SENAFSS', 'SENAFS', 'SENAMO', 'SENACREX'
];
const basePostesCA = ['PCA', 'Administrateur', 'Administratrice'];
const basePostesCCC = ['Commissaire Central aux Comptes'];
const basePostesCC = ['Président du Conseil Consultatif', 'Membre du Conseil Consultatif'];
const basePostesCP = ['Président du Conseil Pédagogique', 'Membre du Conseil Pédagogique'];

const basePostesSR = [
  'SR', 'Vice-SR', 'SERAFAD', 'SERAFI', 'SERAFOCI', 'SERAFOCUS', 'SERACEF',
  'SERAFS', 'SERAFSS', 'SERAMO', 'SERACREX', 'Commissaire aux Comptes Régional'
];

// New postes to be added for 'ACTUEL' members
const newPostesCE_Actual = [
  'SENASIP',
  'SENAES'
];
const newPostesSR_Actual = [
  'SERASIP',
  'SERAES'
];

// Postes to be removed for 'ACTUEL' members
const removedPostesCE_Actual = ['SENAFSS', 'SENAFS', 'SENAFOCUS'];
const removedPostesSR_Actual = ['SERAFSS', 'SERAFS', 'SERAFOCUS'];
...
// Définitions des postes SR (updated with new ones)
const postesSRDefinitions = {
  ...
  'SERAFOCUS': 'Secrétaire Régional chargé de la Formation, de la Culture et du Sport',
  'SERACEF': 'Secrétaire Régional chargé des Cellules Féminines',
  'SERAFS': 'Secrétaire Régional chargé des Affaires Sociales',
  'SERAFSS': 'Secrétaire Régional chargé des Affaires Sociales et Sportives',
  ...
  'Imam Régional': 'Imam Régional',
  'SERASIP' : 'Secrétaire Régional chargé des Affaires Sociales et de l\'Insertion Professionnelle',
...
const postesDefinitions = {
  ...
  'Délégué Social': 'D.S',
  'Délégué Social Adjoint': 'D.S. Adjoint',
  ...
  'Imam de Sous-comité': 'Imam de Sous-comité',
  'Formateur de Sous-comité': 'Formateur de Sous-comité',
  'Membre d\'une Cellule Spécialisée (Sous-comité)': 'Membre d\'une Cellule Spécialisée (Sous-comité)',
  'Membre simple': 'Membre simple',
  'Imam de Section': 'Imam de Section',
  'Formateur de section': 'Formateur de section',
  'Membre d\'une Cellule Spécialisée (Section)': 'Membre d\'une Cellule Spécialisée (Section)'
};

// Nouvelles définitions pour les postes du Comité Exécutif (updated with new ones)
const postesCEDefinitions = {
  'AMIR': 'Amir',
  'Vice-Amir': 'Vice-Amir',
  'Vice Amirate': 'Vice Amirate',
  'SENAFI': 'Secrétaire National aux Affaires Financières',
  'SENAFOCI': 'Secrétaire National à la Formation, à la Culture et aux Questions Idéologiques',
  'SENAFOCUS': 'Secrétaire National Chargé de la Formation, de la Culture et du Sport',
  'SENACEF': 'Secrétaire National aux Cellules Féminines',
  'SENAFAD': 'Secrétaire National aux Affaires Administratives',
  'SENAFSS': 'Secrétaire National aux Affaires Sociales et Sportives',
  'SENAFS': 'Secrétaire National Chargé des Affaires Sociales',
  'SENAMO': 'Secrétaire National à la Mobilisation et à l\'Organisation',
  'SENACREX': 'Secrétaire National à la Communication et aux Relations Extérieures',
  'Commissaire Central aux Comptes': 'Commissaire Central aux Comptes',
  'Administrateur': 'Membre du Conseil d\'Administration',
  'Administratrice': 'Membre du Conseil d\'Administration',
  'Président du Conseil Consultatif': 'Président du Conseil Consultatif',
  'Membre du Conseil Consultatif': 'Membre du Conseil Consultatif',
  'PCA': 'Président du Conseil d\'Administration',
  'Président du Conseil National Pédagogique': 'Président du Conseil National Pédagogique',
  'Membre du Conseil National Pédagogique': 'Membre du Conseil National Pédagogique',
  'SENASIP': 'Secrétaire National chargé des Affaires Sociales et de l\'Insertion Professionnelle',
  'SENAES': 'Secrétaire National chargé de l\'Environnement et du Sport'
};

// Computed property for available postes based on type_membre and organe/statut
const computedAvailablePostes = computed(() => {
  const typeMembre = formData.value.type_membre;
  const organe = formData.value.organe;
  const statut = formData.value.statut;
  let postesList = [];

  if (organe === 'COMITE_EXECUTIF') {
    if (statut === 'MEMBRE_CE') {
      postesList = [...basePostesCE];
      if (typeMembre === 'ACTUEL') {
        postesList = postesList.filter(p => !removedPostesCE_Actual.includes(p)).concat(newPostesCE_Actual);
      }
    } else if (statut === 'MEMBRE_CA') {
      postesList = [...basePostesCA];
    } else if (statut === 'MEMBRE_CCC') {
      postesList = [...basePostesCCC];
    } else if (statut === 'MEMBRE_CC') {
      postesList = [...basePostesCC];
    } else if (statut === 'MEMBRE_CP' || statut === 'MEMBRE_CNP') {
      postesList = [...basePostesCP];
    }
  } else if (organe === 'SECRETARIAT_REGIONAL') {
    if (statut === 'SR') {
      postesList = [...basePostesSR];
      if (typeMembre === 'ACTUEL') {
        postesList = postesList.filter(p => !removedPostesSR_Actual.includes(p)).concat(newPostesSR_Actual);
      }
    } else if (statut === 'IMAM_REGIONAL') {
      postesList = ['Imam Régional']; // Fixed poste
    } else if (statut === 'MEMBRE_CRP') {
      postesList = ['Membre du Conseil Régional Pédagogique (CRP)']; // Fixed poste
    }
  } else if (organe === 'SOUS_COMITE') {
    if (statut === 'SOUS_COMITE') {
      postesList = [...postesGeneraux];
    } else if (statut === 'IMAM_SOUS_COMITE') {
      postesList = ['Imam de Sous-comité']; // Fixed poste
    } else if (statut === 'FORMATEUR_SOUS_COMITE') {
      postesList = ['Formateur de Sous-comité']; // Fixed poste
    } else if (statut === 'MEMBRE_CELLULE_SOUS_COMITE') {
      postesList = ['Membre d\'une Cellule Spécialisée (Sous-comité)']; // Fixed poste
    }
  } else if (organe === 'SECTION') {
    if (statut === 'BUREAU_SECTION') {
      postesList = [...postesGeneraux];
    } else if (statut === 'IMAM_SECTION') {
      postesList = ['Imam de Section']; // Fixed poste
    } else if (statut === 'FORMATEUR_SECTION') {
      postesList = ['Formateur de section']; // Fixed poste
    } else if (statut === 'MEMBRE_CELLULE_SECTION') {
      postesList = ['Membre d\'une Cellule Spécialisée (Section)']; // Fixed poste
    } else if (statut === 'MEMBRE_SIMPLE') {
      postesList = ['Membre simple']; // Fixed poste
    }
  }
  return postesList;
});
...
// Fonction pour obtenir le poste avec préfixe "Past" si ancien membre
const getDisplayPoste = () => {
  if (!formData.value.poste) return ''

  if (formData.value.type_membre === 'ANCIEN') {
    return `Past ${formData.value.poste}`
  }

  return formData.value.poste
}
...
const getPosteDefinition = (poste) => {
  // Check specific definitions first
  if (postesCEDefinitions[poste]) {
    return postesCEDefinitions[poste];
  }
  if (postesSRDefinitions[poste]) {
    return postesSRDefinitions[poste];
  }
  // Fallback to general definitions
  return postesDefinitions[poste] || '';
}

// Fonction pour vérifier si on doit afficher la définition
const shouldShowDefinition = (poste) => {
  return getPosteDefinition(poste) !== '';
}
...
const openPosteModal = () => {
  ...
  filteredPostesModal.value = computedAvailablePostes.value // Use computed property
...
const filterPostesModal = () => {
  ...
  filteredPostesModal.value = computedAvailablePostes.value.filter(p => // Use computed property
...
const filterPostes = () => {
  ...
  filteredPostes.value = computedAvailablePostes.value.filter(p => // Use computed property
    p.toLowerCase().includes(search)
  )
}
...
const generateMatricule = () => {
  ...
  // Pour les anciens membres du Comité Exécutif, pas besoin de secrétariat/sous-comité
  if (formData.value.type_membre === 'ANCIEN' && formData.value.organe === 'COMITE_EXECUTIF') {
    const ceCode = 'CE'
    const posteCode = formData.value.poste ? formData.value.poste.substring(0, 3).toUpperCase() : 'XXX'
    const numeroCode = numeroOrdre.value.toString().padStart(3, '0')
    return `${ceCode}-${posteCode}-${numeroCode}`
  }
...
const canProceedToNextStep = computed(() => {
  switch (currentStep.value) {
    case 0:
      return formData.value.type_membre
    case 1:
    ...
    case 2:
      // Les champs de militantisme sont maintenant requis pour tous
    ...
    case 3:
      ...
      // Validation pour Comité Exécutif (MEMBRE_CE, MEMBRE_CA, MEMBRE_CC, MEMBRE_CNP)
      if (['MEMBRE_CE', 'MEMBRE_CA', 'MEMBRE_CC', 'MEMBRE_CNP', 'MEMBRE_CCC', 'MEMBRE_CP'].includes(formData.value.statut)) {
        return formData.value.poste
      }
...
const downloadFiche = () => {
  const ficheContent = `FICHE D'INSCRIPTION AEEMCI
========================
Type de membre: ${formData.value.type_membre === 'ACTUEL' ? 'Membre Actuel' : 'Ancien Membre'}
Informations Personnelles:
...
- SR de début: ${formData.value.srDebut || 'N/A'}
- Sous-comité: ${formData.value.sousComite || 'N/A'}
- Année de début: ${formData.value.anneeDebut || 'N/A'}
Statut et Poste:
- Organe: ${formData.value.organe}
- Statut: ${formData.value.statut}
- Poste: ${getDisplayPoste() || 'N/A'}
...
// Watcher for statut, type_membre, and organe
watch(() => formData.value.statut, (newStatut) => {
  formData.value.poste = '';
  posteSearch.value = '';
  formData.value.posteDefinition = '';

  // Define automatically the poste for Imams and Formateurs
  if (newStatut === 'IMAM_REGIONAL') {
    formData.value.poste = 'Imam Régional';
  } else if (newStatut === 'IMAM_SOUS_COMITE') {
    formData.value.poste = 'Imam de Sous-comité';
  } else if (newStatut === 'IMAM_SECTION') {
    formData.value.poste = 'Imam de Section';
  } else if (newStatut === 'FORMATEUR_SOUS_COMITE') {
    formData.value.poste = 'Formateur de Sous-comité';
  } else if (newStatut === 'FORMATEUR_SECTION') {
    formData.value.poste = 'Formateur de section';
  } else if (newStatut === 'MEMBRE_CRP') {
    formData.value.poste = 'Membre du Conseil Régional Pédagogique (CRP)';
  } else if (newStatut === 'MEMBRE_CELLULE_SOUS_COMITE') {
    formData.value.poste = 'Membre d\'une Cellule Spécialisée (Sous-comité)';
  } else if (newStatut === 'MEMBRE_CELLULE_SECTION') {
    formData.value.poste = 'Membre d\'une Cellule Spécialisée (Section)';
  } else if (newStatut === 'MEMBRE_SIMPLE') {
    formData.value.poste = 'Membre simple';
  }

  filterPostes(); // Re-filter based on new statut
});

watch(() => formData.value.type_membre, () => {
  // Reset relevant fields when type_membre changes, as available postes will change
  formData.value.organe = '';
  formData.value.statut = '';
  formData.value.poste = '';
  posteSearch.value = '';
  formData.value.posteDefinition = '';
  filterPostes(); // Re-filter based on new type_membre
});

watch(() => formData.value.organe, () => {
  // Reset relevant fields when organe changes, as available postes will change
  formData.value.statut = '';
  formData.value.poste = '';
  posteSearch.value = '';
  formData.value.posteDefinition = '';
  filterPostes(); // Re-filter based on new organe
});
</script>
