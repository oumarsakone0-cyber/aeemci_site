<template>
  <div class="app">
    ...
    <!-- Footer -->
    <footer class="footer" style="background-color: #15803d;">
      ...
      <div class="container">
        <div class="footer-content">
          <div class="footer-section">
            ...
            <p class="footer-description">
              L'Association des Élèves et Étudiants Musulmans de Côte d'Ivoire œuvre pour l'épanouissement de la jeunesse musulmane dans l'excellence académique et les valeurs islamiques.
            </p>
          </div>
          ...
          <div class="footer-section">
            ...
            <ul class="contact-info">
              ...
              <li>📞 +225 07 33 75 42 12</li>
              <li>✉️ info@aeemci-ce.ci / aeemci@yahoo.fr</li>
            </ul>
          </div>
          ...
          <div class="footer-section">
            ...
            <ul class="opening-hours">
              <li><span>Lundi - Vendredi</span> <span>8h - 20h</span></li>
              <li><span>Samedi</span> <span>9h - 16h</span></li>
        ...
        <div class="footer-bottom">
          <p>&copy; 2024 AEEMCI. Tous droits réservés.</p>
