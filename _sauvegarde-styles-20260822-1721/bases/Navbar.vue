<template>
  <div class="app">
    <!-- Header avec navigation redesignée - menu à droite -->
    <header class="header">
      <div class="container">
        <div class="header-content">
          ...
          <nav class="main-nav" :class="{ 'mobile-open': mobileMenuOpen }">
            <ul class="nav-list">
              <li class="nav-item"><router-link to="/" class="nav-link active">Accueil</router-link></li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link" @click.prevent="toggleDropdown('aeemci')">
                  AEEMCI <span class="dropdown-arrow">{{ dropdowns.aeemci ? '▲' : '▼' }}</span>
                </a>
                <ul class="dropdown-menu" v-show="dropdowns.aeemci">
                  <li><router-link to="/aeemci/historique">Histoire</router-link></li>
                  <li><router-link to="/aeemci/bureau">Bureau Exécutif</router-link></li>
                  <li><router-link to="/aeemci/organes_centraux">Organes Centraux</router-link></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link" @click.prevent="toggleDropdown('activites')">
                  Activités <span class="dropdown-arrow">{{ dropdowns.activites ? '▲' : '▼' }}</span>
                </a>
                <ul class="dropdown-menu" v-show="dropdowns.activites">
                  <li><router-link to="/activites/education">Éducation</router-link></li>
                  <li><router-link to="/activites/formations">Formations</router-link></li>
                  <li><router-link to="#">Opportunités</router-link></li>
                </ul>
              </li>
              <li class="nav-item"><router-link to="/medias/images" class="nav-link active">Médiathèque</router-link></li>
              <li class="nav-item"><router-link to="/contact" class="nav-link">Contact</router-link></li>
              <li class="nav-item nav-buttons">
                <a href="#" class="btn-espace">Espace Organe</a>
...
// Fonction pour fermer tous les dropdowns sauf celui qui est cliqué
