...
.bureau-hero {
  position: relative;
  background: linear-gradient(135deg, #018404, #166534);
  color: white;
  padding: 6rem 2rem;
  text-align: center;
  overflow: hidden;
...
.mission-card::before {
  ...
  right: 0;
  height: 4px;
  background: linear-gradient(90deg, #018404, #fb923c, #fbbf24);
}
...
.author-line {
  width: 60px;
  height: 2px;
  background: linear-gradient(90deg, #018404, #fb923c);
}
...
.org-position:hover {
  ...
  box-shadow: 0 15px 40px rgba(1, 132, 4, 0.2);
  border-color: #018404;
}
...
.org-connector::before {
  ...
  width: 2px;
  height: 100%;
  background: linear-gradient(to bottom, #018404, #fb923c);
}
...
.bureau-member-card:hover {
  ...
  box-shadow: 0 15px 40px rgba(1, 132, 4, 0.15);
  border-color: #018404;
}
...
.value-card:hover {
  ...
  border-color: #018404;
  box-shadow: 0 20px 50px rgba(1, 132, 4, 0.2);
  background: linear-gradient(135deg, rgba(1, 132, 4, 0.05), rgba(251, 146, 60, 0.05));
}
