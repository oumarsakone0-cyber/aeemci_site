...
.header-icon {
  ...
  color: #018404;
  box-shadow: 0 10px 30px rgba(1,132,4,0.2);
}
...
.btn-primary {
  background: linear-gradient(135deg, #018404, #16a34a);
  color: white;
  box-shadow: 0 10px 30px rgba(1,132,4,0.3);
}

.btn-primary:hover:not(:disabled) {
  transform: translateY(-3px);
  box-shadow: 0 15px 40px rgba(1,132,4,0.4);
}
...
.contact-item:hover {
  border-color: #018404;
  transform: translateY(-2px);
  box-shadow: 0 10px 20px rgba(1,132,4,0.1);
}
