...
.app-container {
  min-height: 100vh;
  background: linear-gradient(135deg, #dcfce7 0%, #f0fdf4 50%, #f9fafb 100%);
...
.bg-green { background: linear-gradient(135deg, #16a34a, #059669); }
...
.btn-primary:hover:not(:disabled) {
  transform: translateY(-2px);
  box-shadow: 0 8px 12px -1px rgba(22, 163, 74, 0.4);
}
