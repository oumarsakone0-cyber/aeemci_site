...
// ================= APPEL API WAVE =================
$baseUrl = "https://api.aeemci-ce.ci/senafoi/wave_callback.php";

$wavePayload = [
    "amount"      => (string) $amount,
    "currency"    => "XOF",
    "success_url" => "$baseUrl?status=success&matricule=$matricule",
    "error_url"   => "$baseUrl?status=error&matricule=$matricule"
];
